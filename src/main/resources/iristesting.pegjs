...
create_table_stmt
 ...
 = a:KW_PURGE __
   ...
   "QUERIES"i __
   KW_BY __
   properties:("AGE"i __ ident / KW_TABLE __ t:table_name __ / "NAME"i __ "%" ident DOT ident DOT ident )?
    / a:KW_PURGE __
    cached:"CACHED"i? __
    "QUERIES"i __
...
create_model_stmt
 = a:KW_CREATE __
   ...
   ife:if_not_exists_stmt? __
   t:table_name __
   "PREDICTING" __ LPAREN __ ident __ RPAREN __
   KW_FROM?__
   t1:table_name __
 ...
 train_model_stmt
  = a:KW_TRAIN __
    KW_MODEL __
    t:table_name __
    (KW_AS __ t1:table_name)? __
    (KW_NOT __ KW_DEFAULT __)? __
    (KW_FOR __ ident __)?
    (KW_WITH __ (ident COMMA)* ident)? __
    (f:KW_FROM __ t2:table_name)? __
